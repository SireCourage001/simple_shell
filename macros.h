...
"	change or add an environment variable. n\n"\
"	initialize a new environment variable, or modify an 
existing one\n"\
"	When there are not correct numbers of arguments, print
error message. \n\n"

#define HELP_UNSETENV_MSG "unsetenv=n"\
	"unsetenv: \tunsetenv VARIABLE\n\n"\
"	The unsetentenv function deletes one variable from the 
environment. \n\n"\
"	When there is no correct numbers of arguments print
error message. \n\n"
...
"	If no argument is given to cd the command will be
interpreted\n"\
"	as cd $HOME. \n"\
"	if the argument help is - (cd -), the command will be
interpreted\n"\
"	as cd $OLDPWD. \n\n"
